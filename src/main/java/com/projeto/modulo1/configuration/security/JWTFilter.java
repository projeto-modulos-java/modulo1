package com.projeto.modulo1.configuration.security;
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if(req.getHeader("Authorization") != null){
            ...
            try {
                ...
                Object perms = information.getClaim("permission");

                if(signedJWT.verify(verifier)){
                    UsernamePasswordAuthenticationToken auth = new UsernamePasswordAuthenticationToken(null, null, getPermissions(perms));
